        ...
        <div className="container mx-auto flex flex-col-reverse md:flex-row items-center justify-between px-6">
          ...
          <div className="relative w-full md:w-1/2 flex items-center justify-center mb-12 md:mb-0">
            ...
            />
              ...
              {/* Main Person Image */}
              <img src={personImage} alt="Person" className="absolute top-[91px] right-[10px] w-[435px] h-[461px] z-20 object-contain" />
              ...
              >
                <div className="text-customBlue font-bold text-lg">100+ Ratings</div>
                <div className="text-gray-500 text-xs mt-1">Trusted by 20,000+ clients</div>
              </motion.div>
            </motion.div>
          </div>
